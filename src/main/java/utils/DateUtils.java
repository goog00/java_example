...
//    public static Date converterDate(String source){
//        try {
//            return DateConverter.getSimpleDateFormat(source).parse(source);
//        } catch (ParseException e) {
//            e.printStackTrace();
//            logger.warn("日期格式化错误",e.getMessage());
//        }
//        return new Date();
//    }
    ...
    /**
     * 根据指定日期，获取改日期的前n天的日期（n是正数表示后一天，n是负数表示前一天）
     * @param specificDate
     * @param days
     * @return
     */
    public static String getBeforeAfterDateByDateParam(Date specificDate,int days){
    ...
    /**
     * 计算日期差
     * @return ThreeTuple<Long,Long,Long> 年 ，月，日
     */
    public static ThreeTuple<Long,Long,Long> differenceBetweenDates(LocalDate startDate,LocalDate endDate){
        ...
        ThreeTuple<Long,Long,Long> threeTuple = new ThreeTuple<>(diffInYears,diffInMonths,diffInDays);
        return threeTuple;
    }
     ...
     * @return ThreeTuple<Long,Long,Long> 年 ，月，日
     */
    public static ThreeTuple<Long,Long,Long> differenceBetweenDates(Date startDate,Date endDate){
        LocalDate localDateStart = dateToLocalDate(startDate);
        LocalDate localDateEnd = dateToLocalDate(endDate);
        return differenceBetweenDates(localDateStart, localDateEnd);
    }
