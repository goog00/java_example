...
public class SortTest {
    ...
    public void setup() {
        ...
        employees.add(new Employee(567, "Parry", "Node", LocalDate.of(2005, Month.JUNE, 07)));
        employees.add(new Employee(467, "Pwm", "Krauss", LocalDate.of(2005, Month.JUNE, 07)));
    ...
    @Test
    public void sort_before_java_8(){
    ...
    public void java_8() {
        ...
        List<Employee> collect = employees.stream().sorted(byEmployeeNumber).collect(Collectors.toList());
//                .forEach(e -> System.out.println(e));
        System.out.println(collect);
    }

    @Test
    public void java_8_inline_lambda(){
        employees.stream().sorted((e1,e2)-> Integer.compare(e1.getEmployeeNumber(),e2.getEmployeeNumber())).forEach(e->System.out.println(e));
    }

    @Test
    public void filter_get_first(){
//        employees.stream().sorted((e1,e2)->e1.getHireDate().compareTo(e2.getHireDate())).forEach(e-> System.out.println(e));

        Optional<Employee> first = employees.stream().sorted((e1, e2) -> e1.getHireDate().compareTo(e2.getHireDate())).findFirst();
    ...
    public void multiple_sort(){
        ...
        employees.stream().sorted(byFirstName).forEach(e-> System.out.println(e));
